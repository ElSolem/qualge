...
quantum_condition :: proc(x: int, y: int) -> bool {
    ...
    if ((y)==(0))|| ((x) == (x)) || ((y) == (y)) || ((x) == (y)) || ((y) == (x)) || ((y) == (y)) || ((x*x) == (x)) || ((x*y) == (x)) || ((y*y) == (x)) || ((x*x) == (y)) || ((x*y) ==(y)) || ((y*y)==(y)) ||((x*x) == (x/y)) || ((x*y) == (x/y)) || ((y*y) == (x/y)) || ((x*x) == (y/x)) || ((x*y) == (y/x)) || ((x*y) == (y/x)) || ((x/x) == (x)) || ((x/y) == (x)) || ((y/y) == (x)) || ((x/x) == (y)) || ((x/y) == (y)) || ((y/y) == (y)) {
        return true
    }
    return math.tan(f32(x) * f32(y)) == math.tan(f32(x)/f32(y))
}
